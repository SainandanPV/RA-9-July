...
public class VehicleApp {
    public static void main(String[] args) {
        ...
        Response response=controller.loadVehiclesFromFile("src/Sample Vehicles.txt");
            ...
            switch (choice) {
                ...
                case 4:
                    try {
                        ...
                        String model = sc.nextLine();
                        controller.rentVehicle(brand, model);
                ...
                case 5:
                    try {
                        ...
                        controller.returnVehicle(returnBrand, returnModel);
